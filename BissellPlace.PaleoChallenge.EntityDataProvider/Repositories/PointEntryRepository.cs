...
namespace BissellPlace.PaleoChallenge.EntityDataProvider.Repositories
{
    ...
    /// </summary>
    public class PointEntryRepository : RestRepository<PointEntry>, IPointEntryRepository
    {
        public PointEntryRepository(IDbContext context, IMappingEngine mappingEngine)
