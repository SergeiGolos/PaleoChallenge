...
namespace BissellPlace.PaleoChallenge.EntityDataProvider.Repositories
{
    ...
    /// </summary>
    public class CommentEntryRepository : RestRepository<CommentEntry>, ICommentEntryRepository
    {
        public CommentEntryRepository(IDbContext context, IMappingEngine mappingEngine)
